"""
Django settings for smartbets project.
...
SECRET_KEY = 'django-insecure-!hl(q#99dm2x9tq61pj**mc)0h(4d^m5gkf6q#(k^cy@_vh@rs'
...
ALLOWED_HOSTS = [
    ...
    "smartbet-backend-mgqo.onrender.com/initiate_payment/"
]
...
WSGI_APPLICATION = 'smartbets.wsgi.application'
